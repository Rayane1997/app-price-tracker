...
class ParserConfigBase(BaseModel):
    ...
    name_selectors: Optional[List[str]] = Field(None, description="Ordered name CSS selectors")
    image_selectors: Optional[List[str]] = Field(None, description="Ordered image CSS selectors")
